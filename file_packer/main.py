...
from file_packer import FilePackReader, pack_directory_contents
...
def main(args):
    if args.output_file:
        ...
        if os.path.exists(args.output_file) and not args.force:
            raise ValueError(
                "The output file path already exists. Run with '-f' to overwrite."
            )
        ...
        reader.print_directory_structure(
            ignore_base_path=True, directories_only=args.directories_only
        )
